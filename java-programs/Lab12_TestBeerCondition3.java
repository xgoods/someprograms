/**
*@Brian Goodwin
*@version 1.0.0 Dec. 6, 2014 - modified Browers Lab12_TestCarCondition3 to work with beer class
**/
public class Lab12_TestBeerCondition3
{
    public static void main(String args[])
    {
        Tree<Beer> myTree = new Tree<Beer>();
        Beer valueToRemove = new Beer("Allagash","Confluence", 11.99);
        BTNode<Beer> root;
...
[Beer:  Allagash Confluence $11.99] removed
