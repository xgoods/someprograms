...
*@version 1.0.0 Dec 6, 2014 - modified browers Lab12_TestCarCondition1 to work with beer class
**/
public class Lab12_TestBeerCondition1
{
    public static void main(String args[])
    {
        Tree<Beer> myTree = new Tree<Beer>();
        Beer valueToRemove = new Beer("Founders","Breakfast Stout",11.98);
        BTNode<Beer> root;
...
[Beer:  Founders Breakfast Stout $11.98] not removed

Tree After removal (Size == 6)
[Beer:  Allagash Confluence $11.99]
[Beer:  Anchor Steam Christmas ale $10.99]
[Beer:  Ballast Point Sculpin $11.99]
[Beer:  DogFishHead 60 min IPA $10.69]
